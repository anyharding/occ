...
<article id="content"><!-- Page Content -->
    ...
    <section class="content_2">
        <section class="top_login_text_head">
            <div class="ribbon_2">
                <p class="ribbon">
                    <strong class="ribbon-content">Edit Company</strong>
                </p>
            </div>
        ...
        <section class="page-container">
            ...
            <section class="contentCol2">
                ...
                <section class="form_contant_box_nw">
                    ...
                    <?php echo form_open_multipart('company/editCompany/' . $this->uri->segment(3), array('name' => 'myform', 'id' => 'myform')); ?>
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'value' => $this->input->post('company') ? $this->input->post('company') : $comp_detail['company']
                            );
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'id' => 'abn',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('abn') ? $this->input->post('abn') : $comp_detail['abn']
                            );
                            echo form_input($data);
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'id' => 'acn',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('acn') ? $this->input->post('acn') : $comp_detail['acn']
                            );
                            echo form_input($data);
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array('name' => 'address',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('address') ? $this->input->post('address') : $comp_detail['address']
                            );
