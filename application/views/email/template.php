                ...
                <div class="block2-inner" style="margin:0 19px;padding:25px 5px 5px;background:#fff; clear:both;">
                    ...
                    <div style="margin:0 auto; width:100%; padding:10px;">
                        ...
                        <div style="padding:0 20px;  ">
                            ...
                            <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">Please remember these details and keep them safe, do not disclose these details others as our company will not disclose your login details to anyone. </p>

                            <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">
                                <b>The link to our system is</b>: <?php echo HTTP_PATH . "s" ?>
                            </p>
