            ...
            <div class="block2-inner" style="margin:0 19px;padding:25px 5px 5px;background:#fff; clear:both;">
             ...
             <div style="margin:0 auto; width:100%; padding:10px;">
              ...
              <div style="padding:0 20px;  ">
                    ...
                    <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">
                        <b>Your Email:</b> <?php echo $email; ?>
                    </p>
                    <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">
                        <b>Your Username:</b> <?php echo $username; ?>
                    </p>
                    <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">
                             <b>Your Password :</b> <?php echo $password;?>
                    </p>
                   <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;">Click here to activate your profile <?php echo $link ?> </p>
