            ...
            <div class="block2-inner" style="margin:0 19px;padding:25px 5px 5px;background:#fff; clear:both;">
             ...
             <div style="margin:0 auto; width:100%; padding:10px;">
              ...
              <div style="padding:0 20px;  ">
                    ...
                    <h2 style="color:#6dad3b; font-weight:26px; font:bold 23px Arial, Helvetica, sans-serif;"><?php echo $message;?>  </h2>
                   
                    <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;"><b>Advertisement</b>  : <?php echo $title;?> </p>
                    <p style="color:#4D4D4D; font:normal 13px Arial, Helvetica, sans-serif;"><b>Transaction Id</b>  : <?php echo $tid;?> </p>
