...
<article id="content"><!-- Page Content -->
    ...
    <section class="content_2">
      ...
      <section class="top_login_text_head">
        <div class="ribbon_2">
          <p class="ribbon"> <strong class="ribbon-content"> Update HR Detail</strong> </p>
        </div>
      </section><?php
    ...
    <div style="text-align: left;color: #999999; font: bold 12px Arial,Helvetica,sans-serif;" class="left-name3"> <span class="required1">*</span> is Required Field.</div>
        <div class="form_contant_box_nw">
          <?php echo form_open('users/editHR/'.$this->uri->segment(3)); ?>
              ...
              <div class="user_name_box2">
                ...
                <div class="text_field_bg">
                  <?php  $data = array('name'=> 'email',
                            'class'     => 'textfield_input','value'       => $user_detail[0]['email']); echo form_input($data); ?>
                </div>
              </div>
              <div class="user_name_box2">
                ...
                <div class="text_field_bg">
                  <?php  $data = array('name'=> 'username',
                            'class'     => 'textfield_input','value'       => $user_detail[0]['username']); echo form_input($data); ?>
                </div>
              </div>
              <div class="user_name_box2">
                ...
                <div class="text_field_bg">
                  <?php  $data = array('name'=> 'contact',
                            'class'     => 'textfield_input','value'       => $user_detail[0]['contact_no']); echo form_input($data); ?>
                </div>
              </div>
