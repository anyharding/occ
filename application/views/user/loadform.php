...
<div style="display: block;">
    <div class="user_name_box2">
        ...
        <div class="text_field_bg">
            ...
            ?>
            <input type="hidden" name="applicant_id" value="<?php echo $detail['id']; ?>">
        </div>
    </div>
    <div class="user_name_box2">
    ...
    <div class="user_name_box2">
        ...
        <div class="text_field_bg">
            ...
            $data = array('name' => 'email',
                'class' => 'textfield_input required', 'value' => $detail['email']);
            echo form_input($data);
            ?>
        </div>
    </div>
    <div class="user_name_box2">
        ...
        <div class="text_field_bg">
            ...
            $data = array('name' => 'contact',
                'class' => 'textfield_input required', 'value' => $detail['mobile']);
            echo form_input($data);
            ?>
        </div>
    </div>
