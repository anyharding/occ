            ...
            <td height="32">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="breadcrumb">Administrator > Add New Recruitment HR</td>
                ...
                <div class="Block table">
                    <div class="BlockContent">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="DataTable">
                            ...
                            <tr>
                                <td>
                                    <?php echo form_open_multipart('admin/recruitments/addRecruitment', array('name' => 'myform')); ?>
                                    ...
                                    ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                $data = array('name' => 'username', 'value' => $this->input->post('username'));
                                                echo form_input($data);
                                    ?></td>
                                        </tr>
