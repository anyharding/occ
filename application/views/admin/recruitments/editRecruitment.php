...
<script>
    ...
    $(document).ready(function(){
        $('#country').change(function(e) {
            $('#example').fadeIn();
            $('#state').load('<?php echo HTTP_PATH; ?>admin/recruitments/getstate/'+this.value);
            $('#example').fadeOut();
        });
    });
    $(function() {
        ...
        <tr>
            <td height="32"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="breadcrumb">Administrator > Update Recruitment HR</td>
                ...
                <div class="Block table">
                    <div class="BlockContent">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="DataTable">
                            ...
                            <tr>
                                <td>
                                    <?php echo form_open_multipart('/admin/recruitments/editRecruitment/' . $this->uri->segment(4)); ?>
                                    <table width="60%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                            <td width="200">First Name <span class="required">*</span>:</td>
                                            <td><?php echo form_input(array('name' => 'firstname', 'id' => 'firstname', 'value' => ($this->input->post('firstname') ? $this->input->post('firstname') : $recruitment_detail[0]['firstname']))) ?></td>
                                        </tr>
                                        <tr>
                                            <td width="200">Last Name <span class="required">*</span>:</td>
                                            <td><?php echo form_input(array('name' => 'lastname', 'id' => 'lastname', 'value' => ($this->input->post('lastname') ? $this->input->post('lastname') : $recruitment_detail[0]['lastname']))) ?></td>
                                        </tr>
                                        <tr>
                                            <td width="200">Email Address <span class="required">*</span>:</td>
                                            <td><?php echo form_input(array('name' => 'email', 'id' => 'email', 'value' => ($this->input->post('email') ? $this->input->post('email') : $recruitment_detail[0]['email']))) ?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                    $data = array('name' => 'username', 'value' => ($this->input->post('username') ? $this->input->post('username') : $recruitment_detail[0]['username']));
                                    ...
                                    ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                $data = array(
                                                    'name' => 'password',
                                                    'value' => $recruitment_detail[0]['password']
                                                );
                                                echo form_input($data);
                                                ?>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                $data = array(
                                                    'name' => 'contact',
                                                    'value' => $this->input->post('contact_no') ? $this->input->post('contact_no') : $recruitment_detail[0]['contact_no']
                                                );
                                                echo form_input($data);
                                                ?></td>
                                        </tr>
                                        ...
                                        <?php //if($recruitment_detail[0]['image'] <> NULL || $recruitment_detail[0]['image'] <> '') {   ?><img width="140" height="140" src="<?php //if($recruitment_detail[0]['image'] == $recruitment_detail[0]['facebook_id'])echo "https://graph.facebook.com/".$recruitment_detail[0]['facebook_id']."/picture?type=large "; else echo HTTP_PATH.'recruitment_images/'.$recruitment_detail[0]['image']   ?>" /> <?php //}  ?>
