<script>
    ...
    {
            document.forms["myform"].action = "<?php  if($this->uri->segment(3) == 'advOwners') echo base_url().'admin/powerusers/deactivateallpoweruser/advOwners'; else echo base_url().'admin/powerusers/deactivateallPoweruser'; ?>";
            document.forms["myform"].submit();
    }
    function submitform2()
    {
            document.forms["myform"].action = "<?php  echo base_url().'admin/powerusers/deleteallpoweruser'; ?>";
            document.forms["myform"].submit();
    }
...
<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="32"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="breadcrumb">Administrator > List Power users</td>
    ...
    <tr>
      ...
      <div class="Block table">
              <div class="BlockContent">
                ...
                <tr>
                  <th>Search Power User by typing its First Name</th>
                </tr>
                <tr>
                  <td align="center" height="80">
	                <?php  echo form_open('/admin/powerusers/index/');?>
    ...
    <tr>
      <td><?php echo form_open('/admin/powerusers/activateallpoweruser', array('id'=>'myform'));?>
			...
			foreach($powerusers as $row){
				if($this->uri->segment(3) == 'advOwners') $link = "/advOwners";else $link = '';
                  ...
                  <tr>
                    ...
                    <td width="13%" class="bl last"><?php if($row->status == 0)echo anchor('admin/powerusers/activatePoweruser/'.$row->id.$link, "<img src=".HTTP_PATH."img/accept.png"." width='16' height='16' border='0'>", 'title = Activate'); else echo anchor('admin/powerusers/deactivatePoweruser/'.$row->id.$link, "<img src=".HTTP_PATH."img/icon1.png"." width='16' height='16' border='0'>", 'title = Deactivate');?>
                      <?php echo anchor('/admin/powerusers/editPoweruser/'.$row->id, "<img src=".HTTP_PATH."img/edit1.gif"."  border='0'>",  'title = Edit'); ?> <?php echo anchor('/admin/powerusers/deletePoweruser/'.$row->id.$link, "<img src=".HTTP_PATH."img/icon2.png"." width='16' height='16' border='0'>",  array('title' => 'Delete','onclick'=>"return confirm('Are you sure you want to delete?')")); ?></td>
                  </tr>
                  <?php
			}?>
                </tbody>
