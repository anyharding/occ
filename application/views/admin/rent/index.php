<script>
    ...
    {
            document.forms["myform"].action = "<?php  if($this->uri->segment(3) == 'advOwners') echo base_url().'admin/rent/deactivateallrent/advOwners'; else echo base_url().'admin/rent/deactivateallrent'; ?>";
            document.forms["myform"].submit();
    }
    function submitform2()
    {
            document.forms["myform"].action = "<?php  echo base_url().'admin/rent/deleteallrent'; ?>";
            document.forms["myform"].submit();
    }
...
<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="32">
          ...
          <tr>
            ...
            <td class="breadcrumb">Administrator > Rent List</td>
    ...
    <tr>
      ...
      <div class="Block table">
              <div class="BlockContent">
                ...
                <tr>
                  <th>Search Rent typing Rent Payment Date</th>
                </tr>
                <tr>
                  <td align="center" height="80">
	                <?php  echo form_open('/admin/rent/index/');?>
    ...
    <tr>
      <td><?php echo form_open('/admin/rent/activateallrent', array('id'=>'myform'));?>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablesorter" id="ListTable">
                <thead>
                  <tr>
                    ...
                    <th width="15%" class="bl">House Address</th>
                    <th width="14%" class="bl">Amount ($)</th>
                    <th width="13%" class="bl">Payment Date</th>
                    <th width="13%" class="bl">Rent Due Date</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="14%" class="bl"><?php echo $this->rent_model->get_houses_address($row->house_id);?></td>
                    <td width="17%" class="bl"><?php echo $row->amount;?></td>
                    <td width="13%" class="bl"><?php echo $row->payment_date;?></td>
                    <td width="17%" class="bl"><?php echo $row->payment_due_date;?></td>
                    <td width="13%" class="bl last"><?php if($row->status == 0)echo anchor('admin/rent/activaterent/'.$row->id.$link, "<img src=".HTTP_PATH."img/accept.png"." width='16' height='16' border='0'>", 'title = Activate'); else echo anchor('admin/rent/deactivaterent/'.$row->id.$link, "<img src=".HTTP_PATH."img/icon1.png"." width='16' height='16' border='0'>", 'title = Deactivate');?>
                    <?php echo anchor('/admin/rent/editrent/'.$row->id, "<img src=".HTTP_PATH."img/edit1.gif"."  border='0'>",  'title = Edit'); ?> <?php echo anchor('/admin/rent/deleterent/'.$row->id.$link, "<img src=".HTTP_PATH."img/icon2.png"." width='16' height='16' border='0'>",  array('title' => 'Delete','onclick'=>"return confirm('Are you sure you want to delete?')")); ?>
                    </td>
                  </tr>
                    <?php
                    }
