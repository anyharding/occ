...
<article id="content"><!-- Page Content -->
    <section class="content_2">
        <section class="top_login_text_head">
            <div class="ribbon_2">
                <p class="ribbon">
                    <strong class="ribbon-content">Add Pay Company</strong>
                </p>
            </div>
        ...
        <section class="page-container">
            ...
            <section class="contentCol2">
                ...
                <section class="form_contant_box_nw">
                    ...
                    <?php echo form_open_multipart('paycompany/addCompany', array('name' => 'myform', 'id' => 'myform')); ?>
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'value' => $this->input->post('account_name')
                            );
...
//                                'id' => 'if_code',
//                                'class' => 'textfield_input required',
//                                'value' => $this->input->post('if_code')
//                            );
//                            echo form_input($data);
                            ?>
                            <?php
                            echo form_dropdown('if_code', $banks, ($this->input->post('if_code') ? $this->input->post('if_code') : ""), 'id="if_code" class="textfield_input required"')
                            ?> 
                        </div>
                    </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'id' => 'account_number',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('account_number')
                            );
                            echo form_input($data);
                            ?>
                        </div>
