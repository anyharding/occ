...
<article id="content"><!-- Page Content -->
    ...
    <section class="content_2">
        <section class="top_login_text_head">
            <div class="ribbon_2">
                <p class="ribbon">
                    <strong class="ribbon-content">Edit Household</strong>
                </p>
            </div>
        ...
        <section class="page-container">
            ...
            <section class="contentCol2">
                ...
                <section class="form_contant_box_nw">
                    ...
                    <?php echo form_open_multipart('household/editHousehold/' . $this->uri->segment(3) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(5), array('name' => 'myform', 'id' => 'myform')); ?>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            <?php
                            echo form_dropdown('category', $category, $this->input->post('category') ? $this->input->post('category') : $household_detail['category'], "class='textfield_input required' size='10'");
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'value' => $this->input->post('des') ? $this->input->post('des') : $household_detail["description"]
                            );
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'value' => $this->input->post('contact') ? $this->input->post('contact') : $household_detail["contact_no"]
                            );
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                ...
                                'id' => 'time',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('time') ? $this->input->post('time') : $household_detail['purchase_time']
                            );
                            echo form_input($data);
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                'name' => 'shop',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('shop') ? $this->input->post('shop') : $household_detail['shop_name']
                            );
                            echo form_input($data);
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            $data = array(
                                'name' => 'receipt',
                                'class' => 'textfield_input required',
                                'value' => $this->input->post('receipt') ? $this->input->post('receipt') : $household_detail['purchase_receipt']
                            );
                            echo form_input($data);
                            ?>
                        </div>
                    ...
                    <div class="user_name_box2">
                        ...
                        <div class="text_field_bg">
                            ...
                            echo form_dropdown('house', $get_houses, $this->input->post('house') ? $this->input->post('house') : $household_detail['house_id'], "id = 'house' class='textfield_input required'");
                            ?> 
