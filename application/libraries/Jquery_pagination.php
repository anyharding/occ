...
class Jquery_pagination {
    ...
    var $loadingId = 'loadingId'; // The page we are linking to
    ...
    function getAJAXlink($count, $text) {
        return "<a href=\"#\" 
					onclick=\"$.post('" . $this->base_url . $count . "', {'t' : 't', beforeSend: function() {
            $('#" . $this->loadingId . "').show('fast');
        }}, function(data){
					$('" . $this->div . "').attr('innerHTML',data);$('#" . $this->loadingId . "').hide('fast');}); " . $this->js_rebind . ";return false;\">"
                . $text . '</a>';
    }
